# About translating OpenKnowHowMetadata

> [!NOTE]
> All commands **must** be run in `./freecad/OpenKnowHowMetadata/resources/translations/` directory.
...
at <https://crowdin.com/project/freecad-addons> webpage and find the **OpenKnowHowMetadata** project.

## Creating file for missing locale

To create a file for a new language with all **OpenKnowHowMetadata** translatable strings execute
...
once done, look for the **OpenKnowHowMetadata** project.
...
Now you can contribute your translated `.ts` file to **OpenKnowHowMetadata** repository,
also include the `.qm` file.

<https://github.com/chennes/OpenKnowHowMetadata>
